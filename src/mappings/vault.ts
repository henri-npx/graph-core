...
export function  handleDeposit (event: DepositEvent): void {
    ...
    deposit.save()
    vault.depositsCount = vault.depositsCount.plus(ONE_BI)
    vault.save()
  }
  ...
  export function  handleRebalance (event: RebalanceEvent): void {
    ...
    newRebalance.save()
    vault.rebalancesCount = vault.rebalancesCount.plus(ONE_BI)
    vault.save()
  }
  ...
  export function  handleRedeem (event: RedeemEvent): void {
    ...
    newRedeem.save()
    vault.redemptionsCount = vault.redemptionsCount.plus(ONE_BI)
    vault.save()
  }
