...
export class Vault extends ethereum.SmartContract {
  ...
  try_getConfigProps(): ethereum.CallResult<
    Vault__getConfigPropsResultValue0Struct
  > {
    let result = super.tryCall(
      "getConfigProps",
      "getConfigProps():((bool,uint8,string,string))",
  ...
  try_getConstantProps(): ethereum.CallResult<
    Vault__getConstantPropsResultValue0Struct
  > {
    let result = super.tryCall(
      "getConstantProps",
      "getConstantProps():((address,uint256,address))",
  ...
  try_getFeesProps(): ethereum.CallResult<
    Vault__getFeesPropsResultValue0Struct
  > {
    let result = super.tryCall(
      "getFeesProps",
      "getFeesProps():((address,uint256,uint256,uint256,uint256,uint256))",
  ...
  try_getHistoryProps(): ethereum.CallResult<
    Vault__getHistoryPropsResultValue0Struct
  > {
    let result = super.tryCall(
      "getHistoryProps",
      "getHistoryProps():((uint256,uint256[],uint256,uint256))",
  ...
  try_getSecurityProps(): ethereum.CallResult<
    Vault__getSecurityPropsResultValue0Struct
  > {
    let result = super.tryCall(
      "getSecurityProps",
      "getSecurityProps():((uint256,uint256,uint256,uint256,uint256,uint256,address))",
